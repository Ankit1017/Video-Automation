...
def build_main_registrations(
    *,
    ...
    return build_main_tab_registrations(
        ...
        cartoon_shorts_service=container.cartoon_shorts_service,
        cartoon_audio_service=container.cartoon_audio_service,
        ...
        cartoon_exporter=container.cartoon_export_service,
